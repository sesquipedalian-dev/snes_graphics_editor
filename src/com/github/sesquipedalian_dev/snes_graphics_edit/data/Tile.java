...
public class Tile {
    ...
    public Tile(int bitDepth) {
        this.bitDepth = bitDepth;
        this.colorSelected = new int[TILE_DIM][TILE_DIM];
    }

    public int[][] getColorsSelected() {
    ...
    public int selectColor(int x, int y, int color) {
        ...
        colorSelected[x - 1][y - 1] = trueColor;
        return trueColor;
    }
    ...
    public static Tile fromString(Scanner in, int bitDepth) throws IOException {
        Tile retVal = new Tile(bitDepth);
        ...
        for(int x = 0; x < TILE_DIM; ++x) {
            ...
            for(int y = 0; y < TILE_DIM; ++y) {
                ...
                retVal.selectColor(x + 1, y + 1, accum + 1);
            }
        }
